...
public class SmsTemplateService {
    ...
    public Long create(SmsTemplateRequestDto requestDto) {
        System.out.println(requestDto.getSmsType());
        System.out.println(requestDto.getTemplateContent());
        SmsTemplate smsTemplate = SmsTemplate.createSmsTemplate(requestDto.getTemplateContent(), SmsType.of(requestDto.getSmsType()));
